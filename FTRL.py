# -*- coding: utf-8 / algorithm: Follow-the-Regularized-Leader -*- 
"""
Thanks to tinrtgu for the wonderful base script (coded in R).
...
L1 = 0.6    # L1-norm regularization, larger value means more regularized
L2 = 0.4     # L2-norm regularization, larger value means more regularized
